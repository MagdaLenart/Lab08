...
public class MainActivity extends AppCompatActivity {
    ...
    private void aktualizuj(){
        ...
        List<Zmiany> historia = bazaDanych.historiaZmianDAO().findHistoryByID(wybraneWarzywoID);
        binding.tekstZmiany.setText("");
        for(Zmiany elem: historia)
        {
            String info = elem.DATE + ", " + elem.TIME + ", " + elem.OLDQUANTITY + " -> " + elem.NEWQUANTITY + "\n";
            binding.tekstZmiany.append(info);
        }
